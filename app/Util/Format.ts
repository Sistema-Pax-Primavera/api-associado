...
export const formatarString = (value: string | null | undefined): string | null => {
    if (!value || typeof value !== 'string') return null
    return value.normalize('NFD').replace(/[\u0300-\u036f]/g, '').toUpperCase()
}

export const formatarNumero = (value: string | null | undefined): string | null => {
    if (!value || typeof value !== 'string') return null;
...
export const formatarData = (value: string | DateTime | Date | null | undefined): string | DateTime | Date | null => {
